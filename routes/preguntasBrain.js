...
const { validatorCreate, validatorID } = require('../validators/preguntasBrainValidators');
const { getItems, getItem, createItem, patchItem, deleteItem } = require('../controllers/preguntasBrain');
