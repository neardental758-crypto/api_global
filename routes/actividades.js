...
const { validatorCreate, validatorID } = require('../validators/actividadesValidators');
const { getItems, getItem, createItem, patchItem, deleteItem } = require('../controllers/actividades');
