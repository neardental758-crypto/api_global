...
const { validatorCreate, validatorID } = require('../validators/participantesActividadesValidators');
const { getItems, getItem, createItem, patchItem, deleteItem } = require('../controllers/participantesActividades');
