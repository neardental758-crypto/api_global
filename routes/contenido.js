...
const { validatorCreate, validatorID } = require('../validators/contenidoValidators');
const { getItems, getItem, createItem, patchItem, deleteItem } = require('../controllers/contenido');
